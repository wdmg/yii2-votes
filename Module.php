...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        ...
        if (Yii::$app instanceof \yii\console\Application)
            $this->controllerNamespace = 'wdmg\votes\commands';
    ...
    {
        Yii::$app->i18n->translations['app/modules/votes'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'sourceLanguage' => 'en-US',
            'basePath' => '@vendor/wdmg/yii2-votes/messages',
        ...
        $this->name = Yii::t('app/modules/votes', $this->name);
        $this->description = Yii::t('app/modules/votes', $this->description);
    }

    public static function t($category, $message, $params = [], $language = null)
    {
        return Yii::t('app/modules/votes' . $category, $message, $params, $language);
    }
    ...
    public function dashboardNavItems()
    {
        return [
            'label' => $this->name,
            'url' => [$this->routePrefix . '/votes/'],
            'active' => in_array(\Yii::$app->controller->module->id, ['votes'])
        ];
    }
}